...
namespace IsekaiLeveling
{
    ...
    public class IsekaiMod : Mod
    {
        ...
        private void DrawGeneralSettings(Listing_Standard listing)
        {
            ...
            if (Settings.EnableForgeSystem)
            {
                ...
                // Refinement component def — lets packs that disable industrial components
                // (e.g. Medieval Overhaul) point refinement at their own component.
                listing.Label("Isekai_Settings_RefinementComponent".Translate() + "  <color=#888888>(Default: ComponentIndustrial)</color>");
                listing.Label("<color=#888888>" + "Isekai_Settings_RefinementComponentDesc".Translate() + "</color>");
                string prevComp = Settings.RefinementComponentDefName;
                Rect compRect = listing.GetRect(30f);
                Settings.RefinementComponentDefName = Widgets.TextField(compRect, Settings.RefinementComponentDefName ?? "ComponentIndustrial");
                if (Settings.RefinementComponentDefName != prevComp)
                    Forge.ForgeUtility.RefreshRefinementComponent();
        ...
        private void DrawQuestsSettings(Listing_Standard listing)
        {
            ...
            // Quest Creature Mod Whitelist
            listing.Gap(8f);
            listing.Label("<b>" + "Isekai_Settings_QuestWhitelistHeader".Translate() + "</b>");
            listing.GapLine();
            listing.Label("Isekai_Settings_QuestWhitelistDesc".Translate());
            listing.Label("<color=#888888>" + "Isekai_Settings_QuestWhitelistHint".Translate() + "</color>");
            listing.Gap(4f);

            Rect whitelistRect = listing.GetRect(30f);
            Settings.QuestCreatureModWhitelist = Widgets.TextField(whitelistRect, Settings.QuestCreatureModWhitelist ?? "");
        }
        ...
        private void DrawEffectsSettings(Listing_Standard listing)
        {
            ...
            listing.CheckboxLabeled("Isekai_Settings_EnableConstellationAuraStyle".Translate(), ref Settings.EnableConstellationAuraStyle,
                "Isekai_Settings_EnableConstellationAuraStyle_Desc".Translate());
        ...
        private void DrawVITSettings(Listing_Standard listing)
        {
            ...
            DrawMultiplierSlider(listing, "Isekai_Settings_RestRate".Translate(), ref Settings.VIT_RestRate, 0f, 0.03f, 0.015f);
        }
    ...
    public class IsekaiSettings : ModSettings
    {
        ...
        // Quest creature mod whitelist. When non-empty, ONLY creatures from mods matching one of
        // these comma-separated keywords are eligible for hunts/bounties (matched against package
        // ID and name). Empty = no restriction. The blacklist still applies on top.
        public string QuestCreatureModWhitelist = "";
        ...
        // Component ThingDef used by item refinement. Default = vanilla ComponentIndustrial.
        // Set to a modded component (e.g. Medieval Overhaul's basic component defName) when
        // industrial components are unavailable. Falls back to ComponentIndustrial if invalid.
        public string RefinementComponentDefName = "ComponentIndustrial";
        ...
        public bool EnableConstellationAuraStyle = true; // Per-constellation palette + behavior + secondary effects
        ...
        public float VIT_RestRate = 0.015f;             // +1.5% rest rate per point (lower to curb instant sleep at high VIT)
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref QuestCreatureModWhitelist, "QuestCreatureModWhitelist", "");
            ...
            Scribe_Values.Look(ref RefinementComponentDefName, "RefinementComponentDefName", "ComponentIndustrial");
            ...
            Scribe_Values.Look(ref EnableConstellationAuraStyle, "EnableConstellationAuraStyle", true);
            ...
            Scribe_Values.Look(ref VIT_RestRate, "VIT_RestRate", 0.015f);
    ...
    public static class IsekaiLevelingSettings
    {
        ...
        public static bool enableConstellationAuraStyle => Settings?.EnableConstellationAuraStyle ?? true;
        ...
        public static bool autoAllowCrystalHauling => Settings?.AutoAllowCrystalHauling ?? false;
        ...
        public static float VIT_RestRate => Settings?.VIT_RestRate ?? 0.015f;
        ...
        public static string RefinementComponentDefName => Settings?.RefinementComponentDefName ?? "ComponentIndustrial";
