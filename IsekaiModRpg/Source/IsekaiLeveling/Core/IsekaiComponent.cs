...
namespace IsekaiLeveling
{
    ...
    public class IsekaiComponent : ThingComp
    {
        ...
        // Which aura to display for this pawn (player choice from the status tab)
        public AuraDisplayMode auraDisplayMode = AuraDisplayMode.Constellation;
        // For multiclass pawns: which constellation's aura to show (treeClass name).
        // null = use the primary assignedTree.
        public string auraConstellation = null;
        ...
        public override void PostExposeData()
        {
            ...
            Scribe_Values.Look(ref auraDisplayMode, "auraDisplayMode", AuraDisplayMode.Constellation);
            Scribe_Values.Look(ref auraConstellation, "auraConstellation", null);
        ...
        private void LevelUp()
        {
            ...
            // Keep the resurrection cache current with this pawn's progression, so a later
            // revive/transform (Shadow Monarch, Pawnmorpher, etc.) restores the real level
            // rather than re-rolling fresh stats.
            Patches.ResurrectionPreserver.CacheSnapshot(Pawn);
