...
namespace IsekaiLeveling.MobRanking
{
    ...
    public static class MobRankUtility
    {
        ...
        public static string GetRankTitle(MobRankTier tier)
        {
            switch (tier)
            {
                case MobRankTier.Nation: return "Isekai_RankTitle_Nation".Translate();
                case MobRankTier.SSS: return "Isekai_RankTitle_SSS".Translate();
                case MobRankTier.SS: return "Isekai_RankTitle_SS".Translate();
                case MobRankTier.S: return "Isekai_RankTitle_S".Translate();
                case MobRankTier.A: return "Isekai_RankTitle_A".Translate();
                case MobRankTier.B: return "Isekai_RankTitle_B".Translate();
                case MobRankTier.C: return "Isekai_RankTitle_C".Translate();
                case MobRankTier.D: return "Isekai_RankTitle_D".Translate();
                case MobRankTier.E: return "Isekai_RankTitle_E".Translate();
                case MobRankTier.F: return "Isekai_RankTitle_F".Translate();
